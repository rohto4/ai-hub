...
const INPUT_PATH = path.join(
  ROOT,
  'artifact/gemini-cli-enrich-backlog-1500/inputs/ai-enrich-inputs-part-008.json',
);
...
const OUTPUT_PATH = path.join(
  ROOT,
  'artifact/gemini-cli-enrich-backlog-1500/output-templates/ai-enrich-outputs-part-008.json',
);
